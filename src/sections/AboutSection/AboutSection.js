  ...
  <Section className="AboutSection" backLayerClassName="AboutSection-backLayer" zIndex={zIndex} wrapperClassName="AboutSection-wrapper">
    <Computer className="AboutSection-computer">
      <div className="AboutSection-content">
        ...
        <p>Do nich należy św. Józef Kalasancjusz, niestrudzony opiekun tych, którzy zajmują&nbsp;się nauczaniem i&nbsp;wychowaniem oraz wszystkich dzieci&nbsp;i&nbsp;młodzieży. Jego charyzmat, misja i&nbsp;duchowość rozwijają się w&nbsp;Kościele od 400 lat i&nbsp;dziś żyją nimi&nbsp;świeccy i&nbsp;zakonnicy w&nbsp;38 krajach na&nbsp;4 kontynentach.</p>
